...
class ActiveRunViewmodel(
    ...
    private val isTracking = combine(shouldTrack, hasLocationPermission) {
    ...
    init {
        ...
        runningTracker
            ...
            .onEach {
                ...
                if (it != null) {
                    Timber.d("location updated ${it.location.lat}, ${it.location.long}")
                } else {
                    Timber.d("location notUpdated location is null")
                }
            }
            .launchIn(viewModelScope)
    ...
    private fun finishRun(mapPictureByte: ByteArray) {
        ...
        viewModelScope.launch {
            ...
            when(val result = repository.upsertRun(run, mapPictureByte)) {
                is Result.Error -> {
